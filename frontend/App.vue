<template>
    <Head>
        ...
        Keep the favicon-og-start and -end! These are used by favicons-og.js
        -->
        ...
        <meta name="theme-color" content="#3396b6">
        <meta name="application-name" content="Furry Music Database">
        ...
        <meta name="apple-mobile-web-app-title" content="Furry Music Database">
        ...
        <meta name="msapplication-TileColor" content="#3396b6">
